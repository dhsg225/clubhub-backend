...
exports.canonicalizeJsonWithLength = canonicalizeJsonWithLength;
...
function serializeValue(value) {
    ...
    if (typeof value === 'number') {
        if (!isFinite(value)) {
            throw new Error(`canonicalizeJson: non-finite number ${value} is not representable in canonical JSON. ` +
 ...
 */
function canonicalizeJsonWithLength(value) {
...
//# sourceMappingURL=canonicalize-json.js.map
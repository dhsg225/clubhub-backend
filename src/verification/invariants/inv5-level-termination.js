...
const types_1 = require("../../pre/types");
(0, index_1.registerInvariant)({
    ...
    assert(output, _input) {
        ...
        const levelTraceFields = {
            [types_1.RESOLUTION_LEVELS.LEVEL_0_EMERGENCY]: 'level_0_emergency',
            [types_1.RESOLUTION_LEVELS.LEVEL_1_OPERATIONAL]: 'level_1_operational',
            [types_1.RESOLUTION_LEVELS.LEVEL_2_SCHEDULED]: 'level_2_scheduled',
            [types_1.RESOLUTION_LEVELS.LEVEL_3_CAMPAIGN]: 'level_3_campaign',
            [types_1.RESOLUTION_LEVELS.LEVEL_4_SPONSORSHIP]: 'level_4_sponsorship',
            [types_1.RESOLUTION_LEVELS.LEVEL_5_STRUCTURAL]: 'level_5_structural',
            [types_1.RESOLUTION_LEVELS.LEVEL_6_DEVICE_TRUTH]: 'level_6_device_truth',
        };
        ...
        if (resolvingEntry === null || resolvingEntry === undefined) {
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `Level termination violation: resolution_level=${level} but ` +
        ...
        for (let higherLevel = 0; higherLevel < level; higherLevel++) {
            ...
            if (higherField && trace[higherField] !== null) {
                ...
                if (entry && typeof entry === 'object' && 'outcome' in entry && entry.outcome === 'SKIP') {
                    continue;
                }
                ...
                if (higherLevel === types_1.RESOLUTION_LEVELS.LEVEL_4_SPONSORSHIP) {
...
//# sourceMappingURL=inv5-level-termination.js.map
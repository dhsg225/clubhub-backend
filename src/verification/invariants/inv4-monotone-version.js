...
(0, index_1.registerInvariant)({
    ...
    assert(output, input) {
        ...
        if (lastDelivery === null) {
            ...
            if (output.version !== 1) {
                return {
                    ...
                    passed: false,
                    severity: 'CONSTITUTIONAL_BREACH',
                    message: `Monotone version violation: no prior delivery exists but output.version=${output.version}. ` +
        ...
        if (checksumChanged) {
            ...
            if (output.version <= 0) {
                return {
                    ...
                    passed: false,
                    severity: 'CONSTITUTIONAL_BREACH',
                    message: `Monotone version violation: checksum changed but version=${output.version}. ` +
            ...
            if (output.version <= 0) {
                return {
                    ...
                    passed: false,
                    severity: 'CONSTITUTIONAL_BREACH',
                    message: `Monotone version violation: checksum unchanged but version=${output.version}. ` +
        ...
        return {
            ...
            passed: true,
            severity: 'CONSTITUTIONAL_BREACH',
            message: `Monotone version holds: checksum_changed=${checksumChanged}, ` +
                `version=${output.version}, prior_checksum=${lastDelivery.checksum}`,
        };
    },
});
//# sourceMappingURL=inv4-monotone-version.js.map
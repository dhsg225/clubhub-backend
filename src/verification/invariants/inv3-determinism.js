...
const fnv1a32_1 = require("../../pre/algorithms/fnv1a32");
const canonicalize_json_1 = require("../../pre/algorithms/canonicalize-json");
    ...
    assert(output, _input) {
        ...
        if (typeof output.playlist_checksum !== 'string' ||
            ...
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `output.playlist_checksum "${output.playlist_checksum}" is not a valid FNV-1a 32-bit hex string. ` +
        ...
        const recomputedChecksum = (0, fnv1a32_1.fnv1a32)((0, canonicalize_json_1.canonicalizeJson)(output.playlist));
        if (recomputedChecksum !== output.playlist_checksum) {
            return {
                invariantId: 'INV-3',
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `Determinism violation: stored playlist_checksum "${output.playlist_checksum}" ` +
        ...
        if (!Number.isInteger(output.version) || output.version < 0) {
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `output.version is ${output.version}. Must be a non-negative integer. ` +
...
//# sourceMappingURL=inv3-determinism.js.map
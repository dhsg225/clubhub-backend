    ...
    assert(output, input) {
        ...
        if (output.screen_id !== input.screen_id) {
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `Purity violation: output.screen_id "${output.screen_id}" ` +
        ...
        if (output.resolved_at !== input.at) {
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `Purity violation: output.resolved_at ${output.resolved_at} ` +
        ...
        if (output.output_schema_version !== '1.0.0') {
            return {
                ...
                passed: false,
                severity: 'CONSTITUTIONAL_BREACH',
                message: `Purity violation: output.output_schema_version is "${output.output_schema_version}", ` +
...
//# sourceMappingURL=inv1-purity.js.map
...
class IncidentOrchestrator {
  ...
  createIncident(opts = {}) {
    ...
    emit('GOVERNANCE.incident_detected', null, withLineage({
      incident_id,
      type:     type ?? 'UNKNOWN',
      severity,
    }, {
      policy_decision_id: policyEvalId,
    }));
...
module.exports = { IncidentOrchestrator, INCIDENT_STATES, LEGAL_TRANSITIONS, IncidentConcurrencyError };
